...
const ItemRenderer = ({ greedy, direction, items, setItems, generateSchema, deleteSelf }) => {
    const componentReducer = (item) => {
        switch(item.name) {
            ...
            case 'TextField':
                return {item, component: <TextField label="text" variant="outlined" style={{width: '100%'}} />};
            case 'PhoneNumberInput':
                return {item, component: <div />};
            case 'Password':
                return {item, component: <TextField label="password" type="password" variant="outlined" style={{width: '100%'}} />};
            case 'RadioGroup':
            ...
            case 'FileUpload':
                return {item, component: <TextField />};
            case 'Dropdown':
                return {item, component: <Dropdown style={{width: '100%'}} />};
            case 'DateInput':
                return {item, component: <TextField />};
